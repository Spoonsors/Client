...
class _TeenagerViewRecipePageWidgetState
  ...
  Widget build(BuildContext context) {
    return Consumer2<LoginService, FridgesService>(
        builder: (context, loginService, fridgesService, child) {
                          ...
                          return Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color:
                                    partContain ? Colors.transparent : primary,
                                borderRadius: BorderRadius.circular(8),
                                border: Border.all(
                                  color: partContain ? Colors.black : primary,
                                ),
                              ),
                              child: Align(
